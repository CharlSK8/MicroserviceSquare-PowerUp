...
public class RestaurantHandlerImpl implements IRestaurantHandler {
    ...
    @Override
    public List<RestaurantResponseDto> getAllRestaurantsByNameAsc(int page, int itemsPerPage) {
        return restaurantResponseMapper.toRestaurantResponseDto(restaurantServicePort.getAllRestaurantsByNameAsc(page, itemsPerPage));
    }
}
